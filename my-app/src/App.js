      ...
      <div className="firstColumn">
            <div className="form-group">
              ...
              <span className="icon-case"><i className="fa fa-male"></i></span>
                <select  style={{background: "#00807c",color: "white",size:"100%",marginLeft:"2px",textAlign: "center"}} type="text" name="nom" class="nom" data-rule="required" data-msg="Missing data"  value={newfinance}
        ...
        <span className="icon-case"><i className="fa fa-male"></i></span>
            <select style={{background: "#00807c",color: "white",size:"100%",marginLeft:"2px",textAlign: "center"}} type="text" name="nom" class="nom" data-rule="required" data-msg="Missing data" value={Idue}
  ...
  {/* ****************************************** */}
    ...
    <div className="secondColumn">
      ...
      <span className="icon-case"><i className="fa fa-location-arrow"></i></span>
        <select style={{background: "#00807c",color: "white",size:"100%",marginLeft:"2px",textAlign: "center"}} type="text"  name="nom" class="nom" data-rule="required" data-msg="Missing data" value={Installment}
      ...
      <span className="icon-case"><i className="fa fa-location-arrow"></i></span>
        <select style={{background: "#00807c",color: "white",size:"100%",marginLeft:"2px",textAlign: "center"}} type="text"  name="nom" class="nom" data-rule="required" data-msg="Missing data" value={Advance}
      ...
      <span className="icon-case"><i className="fa fa-map-marker"></i></span>
        <select style={{background: "#00807c",color: "white",size:"100%",marginLeft:"2px",textAlign: "center"}} type="text"  name="nom" class="nom" data-rule="required" data-msg="Missing data" value={Stagee}
  ...
  {/* *********************************************** */}
   ...
   <div className="thirdColumn">  
      ...
      <span className="icon-case"><i className="fa fa-building-o"></i></span>
        <select style={{background: "#00807c",color: "white",size:"100%",marginLeft:"2px",textAlign: "center"}} type="text"  name="nom" class="nom" data-rule="required" data-msg="Missing data" value={Daycount}
      ...
      <span className="icon-case"><i className="fa fa-info"></i></span>
                <select style={{background: "#00807c",color: "white",size:"100%",marginLeft:"2px",textAlign: "center"}}  name="nom" class="nom" data-rule="required" data-msg="Missing data" value={IStage}
      ...
      <span className="icon-case"><i className="fa fa-comment-o"></i></span>
                <select  style={{background: "#00807c",color: "white",height:"100% !important",marginLeft:"2px",textAlign: "center"}}type="text"  name="nom" class="nom" data-rule="required" data-msg="Missing data." value={InstallmentF}
